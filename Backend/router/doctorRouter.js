...
const {viewDoctorById}=require("../controller/doctor/viewById");
const {updatePassword,updateDoctorById,addContactNumber,removeContactNumber,addEducation,removeEducation,addHospital,deleteHospital,addVideo,deleteVideo,addDates,deleteDates,addContactNumberByAdmin,removeContactNumberByAdmin}=require("../controller/doctor/update");
const {profileImageChange,coverImageChange}=require("../controller/doctor/ImageChange")
const {viewDoctorByNameAndTag,addTagById,deleteTagById}=require("../controller/doctor/doctorByNameAndTag");
const {deleteDoctorById}=require("../controller/doctor/delete");
...
doctorRoute.post("/add/profile/image/:id",upload.single("img"),profileImageChange);
//cover Image Change
doctorRoute.post("/add/cover/image/:id",upload.single("img"),coverImageChange);
