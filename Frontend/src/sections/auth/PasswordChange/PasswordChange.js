...
import { DoctorLogout, DoctorPasswordChange } from '../../../apigetway/actions/DoctorAction';
import Error from '../../../pages/Error';

// ----------------------------------------------------------------------

export default function PasswordChange({ docId }) {
  ...
  const formik = useFormik({
    ...
    onSubmit: () => {
      if (values.password !== values.confirmPassword) {
        ...
        dispatch(DoctorPasswordChange(docId, values.password));
      }
    },
  });
