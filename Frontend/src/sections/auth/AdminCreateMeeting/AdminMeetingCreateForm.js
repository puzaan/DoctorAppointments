...
export default function AdminMeetingCreateForm({ data }) {
  ...
  const RegisterSchema = Yup.object().shape({
    patientName: Yup.string().min(2, 'Too Short!').max(50, 'Too Long!').required('Enter your name'),
    ...
    phoneNumber: Yup.string().matches(phoneRegExp, 'Phone number is not valid').required('Enter your contact Number'),
  });
