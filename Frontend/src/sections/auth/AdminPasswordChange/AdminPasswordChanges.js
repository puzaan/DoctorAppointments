...
export default function AdminPasswordChanges({ adminId }) {
  ...
  const { error, success } = adminPasswordChange;
  ...
  const formik = useFormik({
    ...
    onSubmit: () => {
      if (values.password !== values.confirmPassword) {
        ...
        dispatch(AdminPasswordChange(adminId, values.password));
      }
    },
  });
...
AdminPasswordChanges.propTypes = {
