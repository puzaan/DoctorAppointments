            ...
            <Grid item container alignItems={"center"} xs={12} md={8}>
              <Box>
                ...
                <Typography component={"p"} align="justify">
                  We address Medical Data loss in Nepal and South Asia. Whenever
                  a patient, mostly poor and underprivileged goes to see a
                  doctor for their medical condition, hospital gives them a
                  booklet with information : Complaints, Observations,
                  ...
                  same or another doctor for the same or another issue, there is
                  no record.
                  <br />
                  ...
                  them to ask for suggestions from Specialists who would be able
                  to guide, instruct or suggest.
                  <br />
                  ...
                  Doctalk, solves this Information Assymetry and lets doctors or
                  team of doctors, collaborate, keep and share medical records,
                  ask for suggestions and support for both the doctor and on
                  behalf of the patient. With Doctalk, all a patient needs to
                  know when going back to hospital is their phone number while a
                  doctor just needs the app and 2G internet.
                </Typography>
              </Box>
            </Grid>
            <Grid
            ...
            >
              <Box>
                ...
                >
                  ...
                  best medical services. We arm rural doctors in particular with
                  information and tools so that the underserved communities get
            ...
            >
              <Box>
                ...
                >
                  ...
                  overwhelming number of your patients, case load, education and
                  research obligations. We have made Doctalk clean and easy
                  without sacrificing functionality. In fact, we confidently
                  claim to make your job easier, seamless, and tidy. We respect
                  your time. We care for your eyes. We are not just another
                  HIMS.
                </Typography>
              </Box>
            </Grid>
