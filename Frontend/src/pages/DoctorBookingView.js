...
// sections
import { SuperBookingCancel, SuperBookingApproved, DoctorViewBooking } from '../apigetway/actions/BookingAction';
...
export default function DoctorBookingView() {
  const { id } = useParams();
  ...
  useEffect(() => {
    dispatch(DoctorViewBooking(doctorInfo.doctorId));
    if (cancelSuccess) {
      window.location.reload(false);
    }
  }, [dispatch, id, success, cancelSuccess, denieDispatch, doctorInfo.doctorId]);
